...
export default function BasicFormControl({ id, value, label, multiline, errors, icon }: { id: string, value?: string, label: string, multiline?: boolean, errors?: string[], icon: any }) {
    const Icon = icon;
    return (
        <>
            <FormControl defaultValue={value} placeholder={label} style={{ width: 'full' }} >
