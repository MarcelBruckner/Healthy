...
export default function Page() {
  ...
  return (
    <div>
      ...
      <div>
        <Link target="_blank" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" href="https://selpers.com/wp-content/uploads/2019/06/Ern%C3%A4hrungs-Symptom-Tagebuch-bei-Durchfall.pdf">Source: selpers.com</Link>
      </div>
    </div >
  );
}
